...
<header id="site-header" class="<?php echo esc_attr( ttfmake_get_site_header_class() ); ?> els-site-header" role="banner">
	...
	<?php endif; ?>
	<div class="site-header-main els">
		<div class="container">
			<div class="els-logo-slider">
